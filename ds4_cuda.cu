...
static int routed_moe_launch(
    ...
    fprintf(stderr, "ds4: routed_moe L%u gate_type=%u down_type=%u q4k=%d nvfp4=%d\n",
            layer_index, gate_type, down_type, q4k_path, nvfp4_path);
...
int ds4_gpu_attention_fp8_heads_tensor(
    ...
    (void)raw_cap;
    (void)raw_start;
    float *scores = (float*)heads->ptr;
    float *output = (float*)heads->ptr + n_head * n_raw;
    launch_fp8_attention(
        (const float*)q->ptr,
        k_fp8_cache,
        v_fp8_cache,
        scores,
...
/* =========================================================================
 * Forward Kernels (merged: ds4_cuda_forward.cu)
 * ========================================================================= */
...
/* =========================================================================
 * FP8 Attention (merged: ds4_cuda_fp8_attention.cu)
 * ========================================================================= */
/**
...
/* =========================================================================
 * Embedding (merged: ds4_cuda_embedding.cu)
 * ========================================================================= */
/**
